...
const (
	...
	BudgetService_GetUserCategories_FullMethodName = "/BudgetService/GetUserCategories"
)
...
type BudgetServiceClient interface {
	...
	GetUserCategories(ctx context.Context, in *GetUserCategoriesRequest, opts ...grpc.CallOption) (*ListGetUserCategoriesResponse, error)
}
...
func (c *budgetServiceClient) GetUserCategories(ctx context.Context, in *GetUserCategoriesRequest, opts ...grpc.CallOption) (*ListGetUserCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListGetUserCategoriesResponse)
	err := c.cc.Invoke(ctx, BudgetService_GetUserCategories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BudgetServiceServer interface {
	...
	GetUserCategories(context.Context, *GetUserCategoriesRequest) (*ListGetUserCategoriesResponse, error)
...
func (UnimplementedBudgetServiceServer) GetUserCategories(context.Context, *GetUserCategoriesRequest) (*ListGetUserCategoriesResponse, error) {
...
func _BudgetService_GetUserCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserCategoriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BudgetServiceServer).GetUserCategories(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BudgetService_GetUserCategories_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BudgetServiceServer).GetUserCategories(ctx, req.(*GetUserCategoriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BudgetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BudgetService_GetUserCategories_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "budgetproto/budget.proto",
}
