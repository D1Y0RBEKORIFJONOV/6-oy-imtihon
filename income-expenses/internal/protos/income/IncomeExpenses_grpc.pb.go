...
// UnimplementedIncomeExpensesServer must be embedded to have
...
func (UnimplementedIncomeExpensesServer) testEmbeddedByValue()                        {}
...
func RegisterIncomeExpensesServer(s grpc.ServiceRegistrar, srv IncomeExpensesServer) {
	// If the following call pancis, it indicates UnimplementedIncomeExpensesServer was
